        ...
        slivers: [
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            height: 60,
                            child: TextField(
                              controller: Provider.of<Dataprovider>(context,listen: false).locationController,
                          onSubmitted: (value) {
          ...
          Consumer<Dataprovider>(
            builder: (context, value, child) => SliverToBoxAdapter(
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("Found ${value.filterList.length} doners around you"),
              ),
            ),
          ),
          Consumer<Dataprovider>(
                      ...
                      child: Row(
                            ...
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  height: 110,
                        decoration: BoxDecoration(
                                    color: const Color.fromARGB(255, 250, 230, 237),
                                    borderRadius: BorderRadius.circular(10),
                        ),
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                           Text("${data.gender ?? '' } ,  ${data.age ??'0'} yr old",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                             ...
                             Row(
                              ...
                              mainAxisAlignment: MainAxisAlignment.start,
                               children: [
                                 ...
                                 Text(data.phone??'',style:TextStyle(fontWeight: FontWeight.bold),),
                               ],
                             ),
                              Row(
                                spacing: 10,
                              mainAxisAlignment: MainAxisAlignment.start,
                               children: [
                                 ...
                                 Text(data.location??'',style:TextStyle(fontWeight: FontWeight.bold),),
                               ],
                             )
                          ],),
                        ),
